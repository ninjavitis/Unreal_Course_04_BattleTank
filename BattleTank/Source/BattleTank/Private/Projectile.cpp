...
AProjectile::AProjectile()
{
	...
	BlastForce = CreateDefaultSubobject<URadialForceComponent>(FName("Radial Force Component"));
	BlastForce->AttachToComponent(CollisionMesh, FAttachmentTransformRules::KeepRelativeTransform);
}
